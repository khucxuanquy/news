...
if( document.location.search && /rvWebsiteVerify=UaYIw8Ut/gi.test(document.location.search) ){
    function rvNotificationPopup(){
        
        var css = '#rv_UaYIw8Ut_notification,#rv_UaYIw8Ut_notification *{font-family:"Open Sans",Helvetica,Arial,sans-serif,Tahoma!important}#rv_UaYIw8Ut_notification{transition-duration:.3s;opacity:1;transform:scale(1);background:#fff;border:1px solid rgba(0,0,0,.125);border-radius:.3rem;position:fixed;z-index:2147483646;top:20px;left:20px;width:400px;padding:25px;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.3);-moz-box-shadow:0 2px 4px 0 rgba(0,0,0,.3);box-shadow:0 2px 4px 0 rgba(0,0,0,.3)}#rv_UaYIw8Ut_notification .rv_notification_logo{background:url(https://app.responsivevoice.org/favicon-96x96.png) no-repeat;background-size:50px 50px;float:left;margin:0 20px 0 0;width:50px;height:50px}#rv_UaYIw8Ut_notification_play{background:url(https://app.responsivevoice.org/images/play.png) no-repeat;background-size:25px 25px;float:left;margin:0 5px 0 0;width:25px;height:25px;cursor:pointer}#rv_UaYIw8Ut_notification .rv_notification_body{float:left;color:#343a40;font-size:13px;width:78%;min-height:50px;vertical-align:middle}#rv_UaYIw8Ut_notification .rv_notification_title{color:#1d643b;font-size:16px;font-weight:700;margin:1px 0 4px 0;display:inline-block}#rv_UaYIw8Ut_notification_close{position:absolute;top:15px;right:15px;font-size:22px;color:#343a40;cursor:pointer;line-height:11px}.rv_notification_clear{clear:both}',
        ...
        rvNotification.innerHTML = '<div id=rv_UaYIw8Ut_notification><div id=rv_UaYIw8Ut_notification_close>Ã—</div><div class=rv_notification_logo></div><div class=rv_notification_body><div id=rv_UaYIw8Ut_notification_play></div><span class=rv_notification_title>ResponsiveVoice URL verified</span><br><span class=rv_notification_text>Your <i style="display: none;">ResponsivVoice</i> code snippet is correctly installed, you may now close this window.</span></div><div class=rv_notification_clear></div></div>';
        document.body.appendChild(rvNotification);

        
        function speakVerification(){
            responsiveVoice.speak( document.getElementById('rv_UaYIw8Ut_notification').getElementsByClassName('rv_notification_text')[0].textContent );
        }

        document.getElementById("rv_UaYIw8Ut_notification_play").addEventListener( "click" , function(e) {
            speakVerification();
        });

        document.getElementById("rv_UaYIw8Ut_notification_close").addEventListener( "click" , function(e) {
            style.remove();
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        xhttp.open("POST", "https://code.responsivevoice.org/verify/UaYIw8Ut", true);
...
var config = {"welcomeMessage":false,"speakSelectedText":true,"speakLinks":true,"speakInactivity":false,"speakEndPage":false,"exitIntent":false,"accesibilityNavigation":false,"accesibilityNavigation2":false,"welcomeMessageTime":false,"text_welcomeMessage":"welcome to website, khuc xuan quy","text_speakInactivity":"","text_speakEndPage":"","text_exitIntent":"","trackEvents":false,"abTesting":false,"analytics_id":null,"another_field":null};
...
//We came from prerender
    ...
    // fix -- kxq --
    function check__text(txt){
        txt = txt.toLowerCase()
        let rg = /à|á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ặ|ẳ|ẵ|è|é|ẹ|ẻ|ẽ|ê|ề|ế|ệ|ể|ễ|ì|í|ị|ỉ|ĩ|ò|ó|ọ|ỏ|õ|ô|ồ|ố|ộ|ổ|ỗ|ơ|ờ|ớ|ợ|ở|ỡ|ù|ú|ụ|ủ|ũ|ư|ừ|ứ|ự|ử|ữ|ỳ|ý|ỵ|ỷ|ỹ|đ/;
        return !rg.test(txt);
    }
