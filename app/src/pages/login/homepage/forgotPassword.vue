<template>
    <div class="forgotPassword__container container">
        ...
        <div class="forgotPassword__body">
            <h1>Quên mật khẩu</h1>
            <p>Bạn quên mật khẩu của mình? Đừng lo lắng! Cung cấp cho chúng 
             tôi email được sử dụng để đăng ký tài khoản của bạn.
             Chúng tôi sẽ gửi cho bạn một liên kết để đặt lại mật khẩu của bạn 
             qua thư. </p>
             <div class="input-group mb-3">
                <input v-model="email" type="email" class="form-control" placeholder="Email" aria-label="Password" aria-describedby="basic-addon1">
            </div>
            <p class="errorMessage" v-show="errorEmail">Vui lòng nhập đúng email</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button @click="sendToEmail" class="btn btn-primary" type="button">Send Email</button>
            </div>
        </div>
    </div>
</template>
